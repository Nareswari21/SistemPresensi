                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" href="<?=base_url()?>matakuliah">Matakuliah</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active"><a href="<?=base_url()?>mahasiswa"><i class="notika-icon notika-support"></i> Mahasiswa</a>
                        </li>
                        <li><a href="<?=base_url()?>matakuliah"><i class="notika-icon notika-edit"></i> Matakuliah</a>
                        </li>
                    ...
                    <!-- <div class="tab-content custom-menu-content">
                        ...
                        <div id="mahasiswa" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="<?=base_url()?>mahasiswa">Data Mahasiswa</a>
                                </li>
                            </ul>
                        </div>
                        <div id="matakuliah" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
